---
name: deepstack
description: Detect the current project technology stack and generate a comprehensive, stack-specific deep research prompt for a chosen topic (security, performance, maintainability, testing, deployment, accessibility, and related concerns). Use when a user wants structured research guidance tailored to their exact stack.
---

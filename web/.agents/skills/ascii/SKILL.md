---
name: ascii
description: Generate clean ASCII diagrams for flows, architectures, sequences, trees, and state machines from a user-provided description. Use when a user asks for a text-based diagram or flow visualization that should be readable in plain text/markdown.
---

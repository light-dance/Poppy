---
name: finalize
description: Clean up recent feature or refactor work by removing false starts, dead code, experimental remnants, and duplication while preserving the working implementation. Use after iterative development when a user asks to consolidate and polish the final result.
---
